...
for j in range(21,80):
	Pe[j].Iext = TimedArray([0*uA]*int((112*ms)/timestep)+[Iext_e*exp(-60.0*(float(j-(len(Pe)/2))/len(Pe))**2.0)]*int((30*ms)/timestep)+[0*uA]*int((250*ms)/timestep)+[0.01*uA]*int((1*ms)/timestep),start=0*ms,dt=timestep)
print "done."
